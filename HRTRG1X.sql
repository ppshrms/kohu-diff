--------------------------------------------------------
--  DDL for Package HRTRG1X
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "HRTRG1X" as
  --para
  ...
  procedure get_number_of_training_by_month(json_str_input in clob,json_str_output out clob);
