--------------------------------------------------------
--  DDL for Package M_HRPY35B_20240213
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "M_HRPY35B_20240213" as
  ...
  global_v_batch_codapp     varchar2(100 char)  := 'M_HRPY35B_20240213';
  global_v_batch_codalw     varchar2(100 char)  := 'M_HRPY35B_20240213';
