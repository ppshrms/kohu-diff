--------------------------------------------------------
--  DDL for Package ALERTMSG_RC
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "ALERTMSG_RC" is
  ...
  procedure gen_tappoinf(p_codcompy varchar2, flg_log in varchar2,p_mailalno varchar2,p_dteeffec date,p_auto varchar2);
  procedure gen_empnotconf(p_codcompy varchar2, flg_log in varchar2,p_mailalno varchar2,p_dteeffec date,p_auto varchar2);
  procedure gen_tbudget(p_codcompy varchar2, flg_log in varchar2,p_mailalno varchar2,p_dteeffec date,p_auto varchar2);
  procedure gen_ttotguar_over(p_codcompy varchar2, flg_log in varchar2,p_mailalno varchar2,p_dteeffec date,p_auto varchar2);
  procedure gen_tcolltrl(p_codcompy varchar2, flg_log in varchar2,p_mailalno varchar2,p_dteeffec date,p_auto varchar2);
  procedure gen_resigncollateral(p_codcompy varchar2, flg_log in varchar2,p_mailalno varchar2,p_dteeffec date,p_auto varchar2);
  procedure gen_guarantorretire(p_codcompy varchar2, flg_log in varchar2,p_mailalno varchar2,p_dteeffec date,p_auto varchar2);
  procedure gen_welcomeemp(p_codcompy varchar2, flg_log in varchar2,p_mailalno varchar2,p_dteeffec date,p_auto varchar2);
  procedure gen_jobpostingexp(p_codcompy varchar2, flg_log in varchar2,p_mailalno varchar2,p_dteeffec date,p_auto varchar2);
