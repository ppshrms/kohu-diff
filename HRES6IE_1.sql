--------------------------------------------------------
--  DDL for Package Body HRES6IE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "HRES6IE" is
-- last update: 26/07/2016 13:16
  ...
  begin
    ...
    p_codempid_query    := nvl(p_codempid_query,global_v_codempid);
  ...
  begin
    ...
    obj_detail.put('codinput', p_codempid_query);
    obj_detail.put('filename', '');
    obj_detail.put('desc_codcours', '');
