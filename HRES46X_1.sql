--------------------------------------------------------
--  DDL for Package Body HRES46X
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "HRES46X" as
  ...
  procedure get_graph (json_str_input in clob, json_str_output out clob) as
    ...
    v_row2          number := 0;
    v_numseq        number := 1;
    v_codapp        varchar2(10 char) := 'HRES46X';
    cursor c1 is
  ...
  begin
    ...
    obj_dataY1 := json_object_t();
    obj_dataY1.put('label',get_label_name('HRES46X1',global_v_lang,460));
    obj_dataY1.put('data',main_dataY1);

    obj_dataY2 := json_object_t();
    obj_dataY2.put('label',get_label_name('HRES46X1',global_v_lang,470));
    obj_dataY2.put('data',main_dataY2);

    obj_main  := json_object_t();
    obj_main.put('dataY1',main_dataY1);
    obj_main.put('dataY2',main_dataY2);
