--------------------------------------------------------
--  DDL for Package HRPY52X
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "HRPY52X" as
  ...
  p_locstart                ttaxcur.codbrlc%type;
  p_locend                  ttaxcur.codbrlc%type;
  p_typpayroll              ttaxcur.typpayroll%type;
  p_numperiod               ttaxcur.numperiod%type;
