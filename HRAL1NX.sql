--------------------------------------------------------
--  DDL for Package HRAL1NX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "HRAL1NX" as
-- last update: 20/04/2018 10:30:00
  ...
  v_fd_key                  varchar2(100 char) := 'HRAL1NX';
  -- report
  p_codapp                  varchar2(10 char) := 'HRAL1NX';
  b_codapp                  varchar2(10 char) := 'HRAL1NX';
  ...
  procedure gen_groupemp(json_str_output out clob,p_cnt_emp number default 0);
