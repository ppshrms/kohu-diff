--------------------------------------------------------
--  DDL for Package HRTRATE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "HRTRATE" is
  ...
  param_msg_error		    varchar2(4000 char);
	...
	g_mailalno		        ttralert.mailalno%type;
	g_dteeffec		        varchar2(100 char);

    p_syncond		        ttralert.syncond%type;
	p_table			        varchar2(4000 char);

	p_codtable		        tcoldesc.codtable%type;

	p_date			        varchar2(100 char);
	p_message		        ttralert.message%type;
	p_subject		        ttralert.subject%type;
