--------------------------------------------------------
--  DDL for Package ALERTMSG_RP
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "ALERTMSG_RP" is
  ...
  procedure batchauto;
  procedure gen_retire(p_codcompy varchar2, flg_log in varchar2,p_mailalno varchar2,p_dteeffec date,p_auto varchar2);
  procedure gen_endwork(p_codcompy varchar2, flg_log in varchar2,p_mailalno varchar2,p_dteeffec date,p_auto varchar2);
  procedure gen_tposempd(p_codcompy varchar2, flg_log in varchar2,p_mailalno varchar2,p_dteeffec date,p_auto varchar2);
  procedure gen_resign(p_codcompy varchar2, flg_log in varchar2,p_mailalno varchar2,p_dteeffec date,p_auto varchar2);
