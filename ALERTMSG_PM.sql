--------------------------------------------------------
--  DDL for Package ALERTMSG_PM
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "ALERTMSG_PM" is
  ...
  procedure batchauto;                                                                                                                                                                                                                                                                                                          v_chken   varchar2(4)   := check_emp(get_emp) ;
  --
