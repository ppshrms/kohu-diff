--------------------------------------------------------
--  DDL for Package Body M_HRPMZ2B_20240208
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "M_HRPMZ2B_20240208" as
...
--insert into a(d) values(v_datarec); commit;
    ...
    begin
        ...
        if v_numerr = 0 then
            ...
            v_temploy1.namempe   := get_tlistval_name('CODTITLE',v_temploy1.codtitle,'101')||' '||v_temploy1.namfirste||' '||v_temploy1.namlaste;
            ...
            if not v_exist then
                insert into temploy1 (codempid,codtitle,namfirste,
                    ...
                    values           (v_temploy1.codempid,v_temploy1.codtitle,v_temploy1.namfirste,
                                      ...
                                      v_temploy1.jobgrade,nvl(v_temploy1.codgrpgl,v_temploy1.codjob),v_temploy1.stamilit,
        ...
        if v_numerr > 0 then
            ...
            if not v_exist then
                ...
                values               (v_ttrehire.codempid,v_ttrehire.dtereemp,v_ttrehire.numreqst,
                                      ...
                                      v_ttrehire.jobgrade,v_ttrehire.codjob,nvl(v_ttrehire.numlvl,v_numlvl),
