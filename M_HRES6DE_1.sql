--------------------------------------------------------
--  DDL for Package Body M_HRES6DE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "M_HRES6DE" AS
/* Cust-Modify: KOHU-SM2301 */
-- last update: 08/12/2023 10:45
...
--      return;
  ...
  procedure check_save is
    v_numseq      tworkreq.seqno%type;
    v_codapp      varchar2(30 char); --user36 KOHU-SM2301 08/12/2023
  begin
...
--    v_tmp_numseq := v_tmp_numseq + 1;
  ...
  begin
    ...
    /*user36 KOHU-SM2301 08/12/2023 cancel
...
--
    ...
    obj_detail.put('error_msg', v_msg_error);
    -->>user36 KOHU-SM2301 06/12/2023
