--------------------------------------------------------
--  DDL for Package HRPY5SX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "HRPY5SX" is
-- last update: 24/08/2018 16:15
  ...
  p_codapp                  varchar2(100 char) := 'HRPY5SX';
  p_codapp_report           varchar2(100 char) := 'HRPY5SXOVR';
  -- index
...
--  function get_detail (json_str_input in clob) return t_hrpy5sx_detail;
--  function gen_detail return T_HRPY5SX_DETAIL;
