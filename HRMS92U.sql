--------------------------------------------------------
--  DDL for Package HRMS92U
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "HRMS92U" is
...
--  p_codcomp           varchar2(100);
  ...
  procedure hrms92u(json_str_input in clob, json_str_output out clob);
  procedure hrms92u_detail_tab1(json_str_input in clob, json_str_output out clob);
