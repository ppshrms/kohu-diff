--------------------------------------------------------
--  DDL for Package Body HRBF5BX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "HRBF5BX" AS
    ...
    begin
        ...
        for i in c1 loop
            v_row := v_row+1;
            if secur_main.secur1(i.codcomp,i.numlvl, global_v_coduser, global_v_zminlvl,global_v_zwrklvl,v_zupdsal,global_v_numlvlsalst,global_v_numlvlsalen) then
                v_row_secur := v_row_secur+1;
                obj_data := json();
--                obj_data.put('dtelonst',hcm_util.get_date_buddhist_era(i.dtelonst));--User37 #5548 BF - Soft Berry 25/03/2021 to_char(i.dtelonst,'dd/mm/yyyy'));
...
--                obj_data.put('dteaccls',hcm_util.get_date_buddhist_era(i.dteaccls));--User37 #5548 BF - Soft Berry 25/03/2021 to_char(i.dteaccls,'dd/mm/yyyy'));
    ...
    begin
        ...
        for i in c1detail loop
            ...
            obj_head.put('dtelonst',hcm_util.get_date_buddhist_era(i.dtelonst));--User37 #5548 BF - Soft Berry 25/03/2021 to_char(i.dtelonst,'dd/mm/yyyy'));
            ...
            obj_head.put('dteissue',hcm_util.get_date_buddhist_era(i.dteissue));--User37 #5548 BF - Soft Berry 25/03/2021 to_char(i.dteissue,'dd/mm/yyyy'));
            obj_head.put('numlon', i.numlon);
            obj_head.put('numlon_year', floor(i.numlon/12));
            obj_head.put('numlon_month', MOD(i.numlon,12));
            obj_head.put('dtestcal',hcm_util.get_date_buddhist_era(i.dtestcal));--User37 #5548 BF - Soft Berry 25/03/2021 to_char(i.dtestcal,'dd/mm/yyyy'));
            obj_head.put('reaslon', i.reaslon);
            obj_head.put('dtelonst',hcm_util.get_date_buddhist_era(i.dtelonst));--User37 #5548 BF - Soft Berry 25/03/2021 to_char(i.dtelonst,'dd/mm/yyyy'));
            obj_head.put('dtelonen',hcm_util.get_date_buddhist_era(i.dtelonen));--User37 #5548 BF - Soft Berry 25/03/2021 to_char(i.dtelonen,'dd/mm/yyyy'));
            ...
            obj_head.put('dteappr',hcm_util.get_date_buddhist_era(i.dteappr));--User37 #5548 BF - Soft Berry 25/03/2021 to_char(i.dteappr,'dd/mm/yyyy'));
            ...
            obj_head.put('dteaccls',hcm_util.get_date_buddhist_era(i.dteaccls));--User37 #5548 BF - Soft Berry 25/03/2021 to_char(i.dteaccls,'dd/mm/yyyy'));
            obj_head.put('amtnpfin',i.amtnpfin);
            obj_head.put('dtelpay',hcm_util.get_date_buddhist_era(i.dtelpay));--User37 #5548 BF - Soft Berry 25/03/2021 to_char(i.dtelpay,'dd/mm/yyyy'));
            obj_head.put('qtyperiod',i.qtyperiod);
  ...
  END get_detail_tab3;
    ...
    begin
        ...
        for i in c1detail loop
            ...
            item11,item12,item13,item14,item15,item16,item17,item18,item19,item20,item21,item22,item23,item25,item26,
            ...
            i.numcont,
            to_char(add_months(i.dtelonst,add_month),'dd/mm/yyyy'),
            nvl(to_char(i.rateilon, 'fm999,999,990.00'), ' ')||' %',i.codlon||' - '||get_ttyploan_name(i.codlon,global_v_lang),
            get_tlistval_name('TYPINTREST',i.typintr,global_v_lang),
            ltrim(to_char(i.amtlon, '9G999G999D00'))
            ,to_char(add_months(i.dteissue,add_month),'dd/mm/yyyy'),
            floor(i.numlon/12),MOD(i.numlon,12),
            to_char(add_months(i.dtestcal,add_month),'dd/mm/yyyy'),
            i.reaslon,to_char(add_months(i.dtelonst,add_month),'dd/mm/yyyy')
            ,to_char(add_months(i.dtelonen,add_month),'dd/mm/yyyy'),
            get_tlistval_name('LOANPAYMT2',i.typpayamt,global_v_lang),
            nvl(to_char(i.amttlpay, 'fm999,999,990.00'), '0.00'),
            i.qtyperiod,
            nvl(to_char(i.amtpaybo, 'fm999,999,990.00'), '0.00'),
            nvl(to_char(i.amtiflat, 'fm999,999,990.00'), '0.00'),
            to_char(add_months(i.dteappr,add_month),'dd/mm/yyyy'),
            i.codappr||' - '||get_temploy_name(i.codappr,global_v_lang), get_tlistval_name('STALOAN', i.stalon,global_v_lang),
            to_char(add_months(i.dteaccls,add_month),'dd/mm/yyyy'),
            i.amtnpfin,
            to_char(add_months(i.dtelpay,add_month),'dd/mm/yyyy'),
            i.qtyperiod,
            i.desaccls,
            v_doc_no);
            v_numseq := v_numseq+1;
            ...
            for k in c2 loop
                ...
                values (global_v_codempid,p_codapp,v_numseq,'asset',k.codcolla,
                get_tcodec_name('TCODCOLA', k.codcolla, global_v_lang),
                ltrim(to_char(k.amtcolla, '9G999G999D00')),
                k.numrefer,
                k.descolla,
                v_row_child,
                v_doc_no);
            ...
            for j in c3 loop
                ...
                'empgar',
                j.codempgar,
                get_temploy_name(j.codempgar,global_v_lang),
                get_tpostn_name(j.codpos,global_v_lang),
                get_tcenter_name(j.codcomp, global_v_lang)
    ...
    begin
        ...
        clear_ttemprpt;
        json_obj          := json(json_str_input);
        param_json := hcm_util.get_json(json_obj, 'numcont');
        FOR i IN 0..param_json.count - 1 LOOP
            v_doc_no := v_doc_no+1;
            v_numcont :=  hcm_util.get_string(param_json,to_char(i));
