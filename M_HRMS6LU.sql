--------------------------------------------------------
--  DDL for Package M_HRMS6LU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "M_HRMS6LU" is
/* Cust-Modify: KOHU-HR2301 */
-- last update: 28/08/2023 12:00
  ...
  -- surachai mo
  p_codcompbg           TTOTREQ.codcompbg%type;
  p_pctbguse            TTOTREQ.pctbguse%type;
  p_dtestrt             ttotreq.dtestrt%type;
  -- p_qtystepappr         ttotreq.qtystepappr%type;
