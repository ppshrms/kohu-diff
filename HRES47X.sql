--------------------------------------------------------
--  DDL for Package HRES47X
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "HRES47X" is
-- last update: 26/07/2016 13:16
  ...
  b_index_dteyrepay         number;
   ...
   p_dtecreatest    tknowleg.dtecreate%type;
   p_dtecreateen    tknowleg.dtecreate%type;
   p_codcours       tknowleg.codcours%type;
