--------------------------------------------------------
--  DDL for Package HRMS93E
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "HRMS93E" is
...
--  p_accuracy                
  ...
  procedure get_codcours(json_str_input in clob, json_str_output out clob);
  procedure gen_codcours (json_str_output out clob);
