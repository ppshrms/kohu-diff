--------------------------------------------------------
--  DDL for Package HRBF55B
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "HRBF55B" AS
/*
...
*/
  ...
  global_v_batch_codapp     varchar2(100 char)  := 'HRBF55B';
  global_v_batch_codalw     varchar2(100 char)  := 'HRBF55B';
  ...
  procedure get_dtepaymt (json_str_input in clob, json_str_output out clob);
  procedure get_lastpay_info (json_str_input in clob, json_str_output out clob);
END HRBF55B;
