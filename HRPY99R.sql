--------------------------------------------------------
--  DDL for Package HRPY99R
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "HRPY99R" as 
  ...
  p_codapp1             varchar2(4000 char) := 'HRPY99R1'; -- ttemprpt ????????
  p_codapp2             varchar2(4000 char) := 'HRPY99R2'; 
