--------------------------------------------------------
--  DDL for Package HRTR3NX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "HRTR3NX" is
  ...
  p_typreport1              varchar2(1 char) ;
  p_typreport2              varchar2(1 char) ;
  p_typreport3              varchar2(1 char) ;
 ...
 -- p_codcomp                 temploy1.codcomp%type;
  ...
  procedure get_rpt_fp1 (json_str_input in clob, json_str_output out clob) ;
  procedure gen_rpt_fp1 (json_str_output out clob) ;
