--------------------------------------------------------
--  DDL for Package HRMS34E
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "HRMS34E" is
-- last update: 22/06/2016 11:20
  ...
  --
  tab1_dtemov       date;
  tab1_codcomp      varchar2(4000 char);
  tab1_codpos       varchar2(4000 char);
  ...
  tab1_codposap       tpostn.codpos%type;
