--------------------------------------------------------
--  DDL for Package Body M_HRMS6NU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "M_HRMS6NU" is
/* Cust-Modify: KOHU-SM2301 */
-- last update: 04/12/2023 11:18
  ...
  PROCEDURE approve(p_coduser         in varchar2,
    ...
    begin
      ...
      begin
        ...
        and    codempid  = r_tleavecc.codempid
        and    dtereq    = r_tleavecc.dtereq
        and    numseq    = r_tleavecc.seqno;
      end;
      -->>user36 KOHU-SM2301 04/12/2023 
