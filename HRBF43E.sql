--------------------------------------------------------
--  DDL for Package HRBF43E
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "HRBF43E" as
    ...
    p_dtepay                date;
    p_dteyrepay             tobfinf.dteyrepay%type;
    p_dtemthpay             tobfinf.dtemthpay%type;
    p_numperiod             tobfinf.numperiod%type;
    p_codappr               tobfinf.codappr%type;
    p_dteappr               tobfinf.dteappr%type;
    p_qtyalw                tobfinf.qtyalw%type;
    p_qtytalw               tobfinf.qtytalw%type;
    ...
    procedure get_header(json_str_input in clob, json_str_output out clob);--hrbf43e

    procedure save_tobfsum(c_codempid in varchar2, c_dtereq in date, c_codobf in varchar2,
                       c_codcomp in varchar2, c_qtyalw in number, c_qtytalw in number);

    procedure save_tobfdep(c_dtereq in date, c_codobf in varchar2,c_codcomp in varchar2);
end hrbf43e;
