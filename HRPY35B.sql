--------------------------------------------------------
--  DDL for Package HRPY35B
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "HRPY35B" as
  ...
  global_v_batch_codapp     varchar2(100 char)  := 'HRPY35B';
  global_v_batch_codalw     varchar2(100 char)  := 'HRPY35B';
