--------------------------------------------------------
--  DDL for Package HRPMC2E2
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "HRPMC2E2" is
-- last update: 07/8/2018 11:40
  ...
  procedure get_internal_training_table(json_str_input in clob, json_str_output out clob);
  procedure gen_internal_training_table(json_str_output out clob);

  procedure get_popup_change_edu_work(json_str_input in clob, json_str_output out clob);
  procedure gen_popup_change_edu_work(json_str_input in clob, json_str_output out clob);
