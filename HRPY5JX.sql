--------------------------------------------------------
--  DDL for Package HRPY5JX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "HRPY5JX" is
-- last update: 24/08/2018 16:15
  ...
  p_codapp                  varchar2(100 char) := 'HRPY5JX';
  p_codapp_report           varchar2(100 char) := 'HRPY5JXOVR';
  -- index
  ...
  -- detail
  p_dteyrepay               number;
  p_dtemthpay               varchar2(100 char);
  p_numperiod               number;
  p_flgpay                  varchar2(1 char);
...
--  function get_detail (json_str_input in clob) return T_TSINCEXP;
--  function gen_detail return T_TSINCEXP;
  procedure get_detail (json_str_input in clob, json_str_output out clob);
  procedure gen_detail (json_str_output out clob);
  procedure get_abnormal_amount (json_str_input in clob, json_str_output out clob);
  procedure gen_data_over (json_str_input in clob, json_str_output out clob);
end HRPY5JX;
